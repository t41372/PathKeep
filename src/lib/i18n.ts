...
const english = {
  ...
  analysisSection: 'Optional AI analysis',
  analysisDescription:
    'Configure providers, build a semantic index, and run grounded assistant queries against the local archive. All AI features are off by default.',
  analysisWorkbench: 'Research workbench',
  analysisWorkbenchDescription:
    'Run semantic retrieval, ask the assistant, and preview external MCP or skill integrations before enabling them.',
  analysisProfileFilter: 'Analysis profile filter',
  providerLibrary: 'Provider library',
  providerLibraryDescription:
    'Create multiple LLM and embedding providers. Each provider combines a request format, optional base URL, model defaults, and keyring-backed API credentials.',
  llmProvidersTitle: 'LLM providers',
  embeddingProvidersTitle: 'Embedding providers',
  addLlmProvider: 'Add LLM provider',
  addEmbeddingProvider: 'Add embedding provider',
  enableAiAnalysis: 'Enable optional AI analysis features',
  enableAssistant: 'Enable the assistant',
  enableSemanticIndex: 'Enable semantic indexing',
  autoIndexAfterBackupLabel:
    'Refresh the semantic index after successful backups',
  enableMcp: 'Enable MCP integration',
  enableSkill: 'Enable skill export guidance',
  llmProviderLabel: 'Default LLM provider',
  embeddingProviderLabel: 'Default embedding provider',
  ...
  clearProviderKey: 'Clear key',
  providerKeyStoredState: 'Key stored',
  providerKeyStored: 'Provider API key stored in the system keyring.',
  providerKeyCleared: 'Provider API key removed from the system keyring.',
  removeProvider: 'Remove provider',
  buildAiIndex: 'Build index',
  rebuildAiIndex: 'Full rebuild',
  aiIndexReadyNotice: 'AI index updated for {count} rows.',
  aiReady: 'AI ready',
  indexedItems: 'Indexed rows',
  selectedLlm: 'Selected LLM',
  selectedEmbedding: 'Selected embedding',
  semanticResults: 'Semantic results',
  semanticSearchLabel: 'Semantic search',
  semanticSearchPlaceholder: 'Ask what you want to retrieve from history',
  runSemanticSearch: 'Run semantic search',
  noSemanticResults:
    'No AI search results yet. Build the index or broaden the search.',
  assistantSection: 'Assistant',
  assistantQuestion: 'Question for the assistant',
  assistantQuestionPlaceholder:
    'What did I research about browser history backup last week?',
  ...
  previewIntegrations: 'Preview MCP and skill files',
  integrationPreviewReady: 'Integration preview is ready.',
  integrationStepsTitle: 'Manual MCP and skill path',
  integrationPreviewEmpty:
    'Generate an integration preview to inspect the MCP command and exported files.',
  mcpCommand: 'MCP command',
  lastIndexedAt: 'Last indexed',
  lastIndexReport: 'Last index run',
  warningLabel: 'Warning',
  enterProviderApiKey: 'Enter an API key for the selected provider first.',
  enterAiSearchQuery: 'Enter a semantic search query first.',
  enterAiQuestion: 'Enter a question for the assistant first.',
  ...
  profiles: 'Profiles',
  insightCoverage: 'Insight coverage',
  lastBackup: 'Last backup',
  noBackupYet: 'No backup yet',
  backupSkipped: 'Backup skipped — not yet due',
  ...
  noHealthChecks: 'No checks reported.',
  ...
  settingsRemote: 'Remote Backup',
  settingsAiProviders: 'AI Providers',
  removeSchedule: 'Remove schedule',
  removeScheduleConfirm:
    'This will unload the native scheduler. You can re-install it later from Settings.',
  scheduleRemoved: 'Schedule removed successfully.',
  days: 'days',
  domainFilter: 'Domain filter',
  domainFilterPlaceholder: 'e.g. github.com',
  profileFilter: 'Profile filter',
  noResultsFound: 'No results found.',
  detailPanel: 'Detail',
  visitTimeLabel: 'Visited at',
  transitionLabel: 'Transition',
  addProvider: 'Add provider',
  aiEnabled: 'Enable AI features',
  aiAssistantEnabled: 'Enable AI assistant',
  semanticIndexEnabled: 'Enable semantic index',
  mcpEnabled: 'Enable MCP integration',
  autoIndexAfterBackup: 'Auto-index after backup',
  enrichmentEnabled: 'Enable enrichment runtime',
  selectedLlmProvider: 'Selected LLM provider',
  selectedEmbeddingProvider: 'Selected embedding provider',
  noneSelected: '(none)',
  enrichmentRuntimeTitle: 'Enrichment runtime',
  enrichmentBoundaryDescription:
    'Deterministic insights still run from canonical archive data. Enrichment plugins add derived context without mutating core visit facts.',
  unlockToInspectRuntime:
  ...
  titleNormalizationDescription:
    'Local-only cleanup for browser titles and URL fallbacks. Safe to run without network access.',
  readableContentPlugin: 'Readable content refetch',
  readableContentDescription:
    'Fetches readable page content for supported URLs. Network-backed and best-effort only.',
  ...
  runInsightsNow: 'Run insights now',
  insightsUpdated: 'Insights updated.',
  explainInsight: 'Explain',
  topicsSection: 'Topics',
  threadsSection: 'Threads',
  trendSlope: 'Trend',
  reopens: 'reopens',
  insightRunReport: 'Insight run report',
  processedVisits: 'Processed visits',
  enrichedVisits: 'Enriched visits',
  insightTopicsCount: 'Topics',
  insightThreadsCount: 'Threads',
  insightCardsCount: 'Cards',
  intelligenceQueueTitle: 'Runtime queue',
  runtimeQueueLoading: 'Loading runtime queue…',
  runtimeQueueUpdated: 'Runtime queue updated.',
  noRuntimeJobs: 'No runtime jobs recorded for this archive window yet.',
  retryJob: 'Retry job',
  ...
  takeoutImportTitle: 'Takeout import',
  takeoutPathLabel: 'Takeout file or folder path',
  takeoutPathPlaceholder: '/path/to/takeout.zip or /path/to/Takeout/',
  takeoutResults: 'Results',
  records: 'records',
  importHistory: 'Import history',
  remoteBackupTitle: 'Remote backup',
  remoteBackupEnabled: 'Enable remote backup',
  lastRemoteUpload: 'Last upload',
  lastRemoteError: 'Last error',
  s3Bucket: 'S3 bucket',
  s3Region: 'S3 region',
  s3Endpoint: 'Custom endpoint',
  s3EndpointPlaceholder: 'Leave empty for AWS S3',
  s3Prefix: 'S3 prefix',
  ...
  uploadUrlLabel: 'Upload URL',
  languageLabel: 'Language',
  storagePaths: 'Storage paths',
  keyringSection: 'Keyring',
  keyringAvailable: 'Keyring available',
  storedInKeyring: 'Stored in keyring',
  commitLabel: 'Commit',
  dirtyLabel: 'Working tree',
  backButton: 'Back',
} as const
...
const dictionaries: Record<ResolvedLanguage, TranslationDictionary> = {
  ...
  'zh-CN': {
    ...
    analysisNav: '分析',
    analysisSection: '可选 AI 分析',
    analysisDescription:
      '配置 provider、建立语义索引，并对本地归档运行带引用的助手查询。所有 AI 功能默认关闭。',
    analysisWorkbench: '研究工作台',
    analysisWorkbenchDescription:
      '运行语义检索、向助手提问，并在启用前预览外部 MCP 或 skill 集成。',
    analysisProfileFilter: '分析配置文件过滤',
    providerLibrary: 'Provider 库',
    providerLibraryDescription:
      '创建多个 LLM 和 embedding provider。每个 provider 都包含请求格式、可选 base URL、模型默认值和保存在钥匙串中的 API 凭据。',
    llmProvidersTitle: 'LLM providers',
    embeddingProvidersTitle: 'Embedding providers',
    addLlmProvider: '添加 LLM provider',
    addEmbeddingProvider: '添加 embedding provider',
    enableAiAnalysis: '启用可选 AI 分析功能',
    enableAssistant: '启用助手',
    enableSemanticIndex: '启用语义索引',
    autoIndexAfterBackupLabel: '成功备份后刷新语义索引',
    enableMcp: '启用 MCP 集成',
    enableSkill: '启用 skill 导出指引',
    llmProviderLabel: '默认 LLM provider',
    embeddingProviderLabel: '默认 embedding provider',
    selectProvider: '选择 provider',
    retrievalTopK: '检索 top-k',
    assistantSystemPrompt: '助手 system prompt',
    ...
    clearProviderKey: '清除密钥',
    providerKeyStoredState: '密钥已保存',
    providerKeyStored: 'Provider API key 已保存到系统钥匙串。',
    providerKeyCleared: 'Provider API key 已从系统钥匙串中移除。',
    removeProvider: '移除 provider',
    buildAiIndex: '建立索引',
    rebuildAiIndex: '完整重建',
    aiIndexReadyNotice: 'AI 索引已更新，共处理 {count} 行。',
    aiReady: 'AI 就绪',
    indexedItems: '已索引行',
    selectedLlm: '已选 LLM',
    selectedEmbedding: '已选 embedding',
    semanticResults: '语义结果',
    semanticSearchLabel: '语义搜索',
    semanticSearchPlaceholder: '输入你想从历史中检索的内容',
    runSemanticSearch: '运行语义搜索',
    noSemanticResults: '还没有 AI 搜索结果。请先建立索引或放宽搜索范围。',
    assistantSection: '助手',
    assistantQuestion: '向助手提问',
    assistantQuestionPlaceholder: '我上周研究过哪些浏览器历史备份相关内容？',
    askAssistant: '询问助手',
    assistantAnswer: '助手回答',
    assistantCitations: '引用',
    assistantEmptyState: '启用 AI 分析并选择 provider 后，再向助手提问。',
    previewIntegrations: '预览 MCP 与 skill 文件',
    integrationPreviewReady: '集成预览已生成。',
    integrationStepsTitle: '手动 MCP 与 skill 路径',
    integrationPreviewEmpty:
      '先生成集成预览，再检查 MCP 命令和导出的文件内容。',
    mcpCommand: 'MCP 命令',
    lastIndexedAt: '最近索引时间',
    lastIndexReport: '最近一次索引运行',
    warningLabel: '警告',
    enterProviderApiKey: '请先为所选 provider 输入 API key。',
    enterAiSearchQuery: '请先输入语义搜索查询。',
    enterAiQuestion: '请先输入要问助手的问题。',
    saveSettings: '保存设置',
    pending: '待处理',
    yes: '是',
    no: '否',
    ...
    startSetup: '开始设置',
    quickStats: '快速统计',
    archiveOverview: '存档概览',
    profiles: '配置文件',
    insightCoverage: '洞察覆盖率',
    lastBackup: '上次备份',
    noBackupYet: '尚未备份',
    backupSkipped: '备份跳过 — 尚未到期',
    ...
    healthReport: '健康报告',
    doctorResults: '诊断结果',
    noHealthChecks: '无检查报告。',
    recentActivity: '最近活动',
    onboardingWelcome: '欢迎',
    onboardingSources: '来源',
    onboardingSecurity: '安全',
    onboardingSchedule: '计划',
    onboardingDone: '完成',
    settingsGeneral: '通用',
    settingsSources: '来源',
    settingsSchedule: '计划',
    settingsSecurity: '安全',
    settingsRemote: '远程备份',
    settingsAiProviders: 'AI 提供商',
    removeSchedule: '移除计划',
    removeScheduleConfirm: '这将卸载原生调度器。你可以稍后从设置中重新安装。',
    scheduleRemoved: '计划移除成功。',
    days: '天',
    domainFilter: '域名筛选',
    domainFilterPlaceholder: '例如 github.com',
    profileFilter: '配置文件筛选',
    noResultsFound: '未找到结果。',
    detailPanel: '详情',
    visitTimeLabel: '访问时间',
    transitionLabel: '转换方式',
    addProvider: '添加 Provider',
    aiEnabled: '启用 AI 功能',
    aiAssistantEnabled: '启用 AI 助手',
    semanticIndexEnabled: '启用语义索引',
    mcpEnabled: '启用 MCP 集成',
    autoIndexAfterBackup: '备份后自动索引',
    enrichmentEnabled: '启用 enrich 运行时',
    selectedLlmProvider: '已选 LLM Provider',
    selectedEmbeddingProvider: '已选 Embedding Provider',
    noneSelected: '（无）',
    enrichmentRuntimeTitle: 'Enrichment 运行时',
    enrichmentBoundaryDescription:
      '即使关闭 enrichment，确定性洞察仍会基于 canonical archive 数据运行。插件只补充派生上下文，不会改写核心访问事实。',
    unlockToInspectRuntime: '请先解锁归档，再查看基于队列的运行时详情。',
    networkAccess: '网络',
    storedRecords: '已存储记录',
    queuedJobs: '排队任务',
    completedJobs: '已完成任务',
    ...
    titleNormalizationDescription:
      '仅本地清理浏览器标题并提供 URL 回退标题，无需网络访问即可安全运行。',
    readableContentPlugin: '可读内容回抓',
    readableContentDescription:
      '为支持的 URL 抓取可读页面内容。依赖网络，且始终是 best-effort。',
    enrichmentPluginFallbackDescription:
      '启用前请先确认该插件的边界和数据来源。',
    insightsGeneratedAt: '生成时间',
    insightCards: '洞察卡片',
    runInsightsNow: '立即运行洞察',
    insightsUpdated: '洞察已更新。',
    explainInsight: '解释',
    topicsSection: '主题',
    threadsSection: '对话',
    trendSlope: '趋势',
    reopens: '重开',
    insightRunReport: '洞察运行报告',
    processedVisits: '已处理访问',
    enrichedVisits: '已丰富访问',
    insightTopicsCount: '主题',
    insightThreadsCount: '对话',
    insightCardsCount: '卡片',
    intelligenceQueueTitle: '运行时队列',
    runtimeQueueLoading: '正在加载运行时队列…',
    runtimeQueueUpdated: '运行时队列已更新。',
    noRuntimeJobs: '这个归档窗口还没有记录运行时任务。',
    retryJob: '重试任务',
    cancelJob: '取消任务',
    attemptLabel: '尝试次数',
    createdAtLabel: '创建时间',
    finishedAtLabel: '完成时间',
    importTakeout: '从 Google Takeout 导入',
    takeoutImportTitle: 'Takeout 导入',
    takeoutPathLabel: 'Takeout 文件或文件夹路径',
    takeoutPathPlaceholder: '/path/to/takeout.zip 或 /path/to/Takeout/',
    takeoutResults: '结果',
    records: '条记录',
    importHistory: '导入历史',
    remoteBackupTitle: '远程备份',
    remoteBackupEnabled: '启用远程备份',
    lastRemoteUpload: '上次上传',
    lastRemoteError: '上次错误',
    s3Bucket: 'S3 存储桶',
    s3Region: 'S3 区域',
    s3Endpoint: '自定义端点',
    s3EndpointPlaceholder: 'AWS S3 无需填写',
    s3Prefix: 'S3 前缀',
    s3PathStyle: '使用路径式寻址',
    s3AccessKeyId: '访问密钥 ID',
    s3SecretAccessKey: '秘密访问密钥',
    objectKeyLabel: '对象键',
    uploadUrlLabel: '上传 URL',
    languageLabel: '语言',
    storagePaths: '存储路径',
    keyringSection: '密钥链',
    keyringAvailable: '密钥链可用',
    storedInKeyring: '已存储在密钥链',
    commitLabel: '提交',
    dirtyLabel: '工作树',
    backButton: '返回',
  },
  'zh-TW': {
    ...
    analysisNav: '分析',
    analysisSection: '可選 AI 分析',
    analysisDescription:
      '配置 provider、建立語意索引，並對本地封存執行帶引用的助手查詢。所有 AI 功能預設關閉。',
    analysisWorkbench: '研究工作台',
    analysisWorkbenchDescription:
      '執行語意檢索、向助手提問，並在啟用前預覽外部 MCP 或 skill 整合。',
    analysisProfileFilter: '分析設定檔篩選',
    providerLibrary: 'Provider 庫',
    providerLibraryDescription:
      '建立多個 LLM 和 embedding provider。每個 provider 都包含請求格式、可選 base URL、模型預設值，以及保存在鑰匙圈中的 API 憑證。',
    llmProvidersTitle: 'LLM providers',
    embeddingProvidersTitle: 'Embedding providers',
    addLlmProvider: '新增 LLM provider',
    addEmbeddingProvider: '新增 embedding provider',
    enableAiAnalysis: '啟用可選 AI 分析功能',
    enableAssistant: '啟用助手',
    enableSemanticIndex: '啟用語意索引',
    autoIndexAfterBackupLabel: '成功備份後刷新語意索引',
    enableMcp: '啟用 MCP 整合',
    enableSkill: '啟用 skill 匯出指引',
    llmProviderLabel: '預設 LLM provider',
    embeddingProviderLabel: '預設 embedding provider',
    selectProvider: '選擇 provider',
    retrievalTopK: '檢索 top-k',
    assistantSystemPrompt: '助手 system prompt',
    ...
    defaultModel: '預設模型',
    modelCatalog: '可用模型',
    modelCatalogHint: '以逗號分隔模型名稱',
    providerEnabled: '啟用 provider',
    temperature: 'Temperature',
    maxTokens: '最大 token 數',
    dimensions: 'Embedding 維度',
    apiKey: 'API key',
    saveProviderKey: '儲存金鑰',
    clearProviderKey: '清除金鑰',
    providerKeyStoredState: '金鑰已儲存',
    providerKeyStored: 'Provider API key 已儲存到系統鑰匙圈。',
    providerKeyCleared: 'Provider API key 已從系統鑰匙圈中移除。',
    removeProvider: '移除 provider',
    buildAiIndex: '建立索引',
    rebuildAiIndex: '完整重建',
    aiIndexReadyNotice: 'AI 索引已更新，共處理 {count} 列。',
    aiReady: 'AI 就緒',
    indexedItems: '已索引列',
    selectedLlm: '已選 LLM',
    selectedEmbedding: '已選 embedding',
    semanticResults: '語意結果',
    semanticSearchLabel: '語意搜尋',
    semanticSearchPlaceholder: '輸入你想從歷史中檢索的內容',
    runSemanticSearch: '執行語意搜尋',
    noSemanticResults: '還沒有 AI 搜尋結果。請先建立索引或放寬搜尋範圍。',
    assistantSection: '助手',
    assistantQuestion: '向助手提問',
    assistantQuestionPlaceholder: '我上週研究過哪些瀏覽器歷史備份相關內容？',
    askAssistant: '詢問助手',
    assistantAnswer: '助手回答',
    assistantCitations: '引用',
    assistantEmptyState: '啟用 AI 分析並選擇 provider 後，再向助手提問。',
    previewIntegrations: '預覽 MCP 與 skill 檔案',
    integrationPreviewReady: '整合預覽已生成。',
    integrationStepsTitle: '手動 MCP 與 skill 路徑',
    integrationPreviewEmpty:
      '先生成整合預覽，再檢查 MCP 命令和匯出的檔案內容。',
    mcpCommand: 'MCP 命令',
    lastIndexedAt: '最近索引時間',
    lastIndexReport: '最近一次索引執行',
    warningLabel: '警告',
    enterProviderApiKey: '請先為所選 provider 輸入 API key。',
    enterAiSearchQuery: '請先輸入語意搜尋查詢。',
    enterAiQuestion: '請先輸入要問助手的問題。',
    saveSettings: '儲存設定',
    pending: '待處理',
    yes: '是',
    no: '否',
    ...
    startSetup: '開始設定',
    quickStats: '快速統計',
    archiveOverview: '存檔概覽',
    profiles: '設定檔',
    insightCoverage: '洞察覆蓋率',
    lastBackup: '上次備份',
    noBackupYet: '尚未備份',
    backupSkipped: '備份跳過 — 尚未到期',
    ...
    healthReport: '健康報告',
    doctorResults: '診斷結果',
    noHealthChecks: '無檢查報告。',
    recentActivity: '最近活動',
    onboardingWelcome: '歡迎',
    onboardingSources: '來源',
    onboardingSecurity: '安全',
    onboardingSchedule: '排程',
    onboardingDone: '完成',
    settingsGeneral: '一般',
    settingsSources: '來源',
    settingsSchedule: '排程',
    settingsSecurity: '安全',
    settingsRemote: '遠端備份',
    settingsAiProviders: 'AI 提供者',
    removeSchedule: '移除排程',
    removeScheduleConfirm: '這將卸載原生排程器。你可以稍後從設定中重新安裝。',
    scheduleRemoved: '排程移除成功。',
    days: '天',
    domainFilter: '域名篩選',
    domainFilterPlaceholder: '例如 github.com',
    profileFilter: '設定檔篩選',
    ...
    detailPanel: '詳情',
    visitTimeLabel: '造訪時間',
    transitionLabel: '轉換方式',
    addProvider: '新增 Provider',
    aiEnabled: '啟用 AI 功能',
    aiAssistantEnabled: '啟用 AI 助手',
    semanticIndexEnabled: '啟用語意索引',
    mcpEnabled: '啟用 MCP 整合',
    autoIndexAfterBackup: '備份後自動索引',
    enrichmentEnabled: '啟用 enrichment runtime',
    selectedLlmProvider: '已選 LLM Provider',
    selectedEmbeddingProvider: '已選 Embedding Provider',
    noneSelected: '（無）',
    enrichmentRuntimeTitle: 'Enrichment runtime',
    enrichmentBoundaryDescription:
      '即使關閉 enrichment，確定性洞察仍會基於 canonical archive 資料執行。插件只補充衍生上下文，不會改寫核心造訪事實。',
    unlockToInspectRuntime: '請先解鎖封存，再查看基於佇列的 runtime 詳情。',
    networkAccess: '網路',
    storedRecords: '已儲存記錄',
    queuedJobs: '排隊工作',
    completedJobs: '已完成工作',
    ...
    titleNormalizationDescription:
      '僅本地清理瀏覽器標題並提供 URL 回退標題，不需網路也能安全執行。',
    readableContentPlugin: '可讀內容回抓',
    readableContentDescription:
      '為支援的 URL 抓取可讀頁面內容。依賴網路，而且始終是 best-effort。',
    enrichmentPluginFallbackDescription:
      '啟用前請先確認這個插件的邊界與資料來源。',
    insightsGeneratedAt: '產生時間',
    insightCards: '洞察卡片',
    runInsightsNow: '立即執行洞察',
    insightsUpdated: '洞察已更新。',
    explainInsight: '解釋',
    topicsSection: '主題',
    threadsSection: '對話',
    trendSlope: '趋勢',
    reopens: '重開',
    insightRunReport: '洞察執行報告',
    processedVisits: '已處理造訪',
    enrichedVisits: '已豐富造訪',
    insightTopicsCount: '主題',
    insightThreadsCount: '對話',
    insightCardsCount: '卡片',
    intelligenceQueueTitle: 'Runtime 佇列',
    runtimeQueueLoading: '正在載入 runtime 佇列…',
    runtimeQueueUpdated: 'Runtime 佇列已更新。',
    noRuntimeJobs: '這個封存視窗還沒有記錄 runtime 工作。',
    retryJob: '重試工作',
    cancelJob: '取消工作',
    attemptLabel: '嘗試次數',
    createdAtLabel: '建立時間',
    finishedAtLabel: '完成時間',
    importTakeout: '從 Google Takeout 匯入',
    takeoutImportTitle: 'Takeout 匯入',
    takeoutPathLabel: 'Takeout 檔案或資料夾路徑',
    takeoutPathPlaceholder: '/path/to/takeout.zip 或 /path/to/Takeout/',
    takeoutResults: '結果',
    records: '筆記錄',
    importHistory: '匯入歷史',
    remoteBackupTitle: '遠端備份',
    remoteBackupEnabled: '啟用遠端備份',
    lastRemoteUpload: '上次上傳',
    lastRemoteError: '上次錯誤',
    s3Bucket: 'S3 儲存桶',
    s3Region: 'S3 區域',
    s3Endpoint: '自訂端點',
    s3EndpointPlaceholder: 'AWS S3 無需填寫',
    s3Prefix: 'S3 前綴',
    s3PathStyle: '使用路徑式尋址',
    s3AccessKeyId: '存取金鑰 ID',
    s3SecretAccessKey: '秘密存取金鑰',
    objectKeyLabel: '物件金鑰',
    uploadUrlLabel: '上傳 URL',
    languageLabel: '語言',
    storagePaths: '儲存路徑',
    keyringSection: '金鑰鏈',
    keyringAvailable: '金鑰鏈可用',
    storedInKeyring: '已存儲在金鑰鏈',
    commitLabel: '提交',
    dirtyLabel: '工作樹',
    backButton: '返回',
  },
