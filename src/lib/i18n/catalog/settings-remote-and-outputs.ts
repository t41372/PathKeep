...
export const settingsRemoteAndOutputsNamespace = {
  en: {
    ...
    migrationExportUnknownError: 'Export failed for an unknown reason.',
    ...
    migrationPreviewUnknownError:
      'The bundle could not be read for an unknown reason.',
    ...
    migrationApplyUnknownError: 'Import failed for an unknown reason.',
  ...
  'zh-CN': {
    ...
    migrationExportUnknownError: '导出因未知原因失败。',
    ...
    migrationPreviewUnknownError: '此数据包因未知原因无法读取。',
    ...
    migrationApplyUnknownError: '导入因未知原因失败。',
  ...
  'zh-TW': {
    ...
    migrationExportUnknownError: '匯出因未知原因失敗。',
    ...
    migrationPreviewUnknownError: '此資料包因未知原因無法讀取。',
    ...
    migrationApplyUnknownError: '匯入因未知原因失敗。',
