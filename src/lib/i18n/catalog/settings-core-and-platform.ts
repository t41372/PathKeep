...
export const settingsCoreAndPlatformNamespace = {
  en: {
    ...
    aiProviderBody:
      'Assistant and smart search are coming in v0.3. v0.2 uses keyword search and Core Intelligence without any AI provider.',
    optional: 'OPTIONAL',
    groupCore: 'CORE',
  ...
  'zh-CN': {
    ...
    aiProvider: 'AI 服务',
    aiProviderBody:
      'AI 助手和智能搜索会在 v0.3 开放。v0.2 不需要 AI 服务，仍可使用关键词搜索和确定性智能分析。',
    optional: '可选',
    groupCore: '核心',
  ...
  'zh-TW': {
    ...
    aiProvider: 'AI 服務',
    aiProviderBody:
      'AI 助手和智慧搜尋會在 v0.3 開放。v0.2 不需要 AI 服務，仍可使用關鍵字搜尋和確定性智慧分析。',
    optional: '可選',
    groupCore: '核心',
