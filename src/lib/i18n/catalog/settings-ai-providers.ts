...
export const settingsAiProvidersNamespace = {
  en: {
    ...
    aiStaticModelBuiltInBadge: 'Built-in · Recommended',
    aiStaticModelTitle: 'Built-in embedding model',
    aiStaticModelDescription:
      'Runs fully on-device — no external server, no API key, no egress. Recommended as the starting point; switch to an external provider only when you need higher accuracy or a larger context window.',
    aiStaticModelNotDownloaded: 'Not downloaded',
    aiStaticModelDownloading: 'Downloading model…',
    aiStaticModelReady: 'Ready',
    aiStaticModelDownloadFailed: 'Download failed. Please try again.',
    aiStaticModelDownloadAction: 'Download model',
    aiStaticModelDownloadingFile: 'Downloading {file}…',
    aiStaticModelCancelDownload: 'Cancel download',
    aiStaticModelActive: 'Active vector model',
    aiStaticModelRecommendedNotSelected: 'Recommended — not selected',
    aiStaticModelSelectAction: 'Use this model',
  ...
  'zh-CN': {
    ...
    aiStaticModelBuiltInBadge: '内置 · 推荐',
    aiStaticModelTitle: '内置嵌入模型',
    aiStaticModelDescription:
      '完全在设备上运行——无需外部服务器、API 密钥或数据出境。推荐作为起点；仅在需要更高精度或更大上下文窗口时才切换到外部 provider。',
    aiStaticModelNotDownloaded: '未下载',
    aiStaticModelDownloading: '正在下载模型…',
    aiStaticModelReady: '已就绪',
    aiStaticModelDownloadFailed: '下载失败，请重试。',
    aiStaticModelDownloadAction: '下载模型',
    aiStaticModelDownloadingFile: '正在下载 {file}…',
    aiStaticModelCancelDownload: '取消下载',
    aiStaticModelActive: '当前向量模型',
    aiStaticModelRecommendedNotSelected: '推荐 — 未选用',
    aiStaticModelSelectAction: '使用此模型',
  ...
  'zh-TW': {
    ...
    aiStaticModelBuiltInBadge: '內建 · 推薦',
    aiStaticModelTitle: '內建嵌入模型',
    aiStaticModelDescription:
      '完全在裝置上執行——無需外部伺服器、API 金鑰或資料外傳。推薦作為起點；僅在需要更高精度或更大上下文視窗時才切換到外部 provider。',
    aiStaticModelNotDownloaded: '未下載',
    aiStaticModelDownloading: '正在下載模型…',
    aiStaticModelReady: '已就緒',
    aiStaticModelDownloadFailed: '下載失敗，請重試。',
    aiStaticModelDownloadAction: '下載模型',
    aiStaticModelDownloadingFile: '正在下載 {file}…',
    aiStaticModelCancelDownload: '取消下載',
    aiStaticModelActive: '目前向量模型',
    aiStaticModelRecommendedNotSelected: '推薦 — 未選用',
    aiStaticModelSelectAction: '使用此模型',
