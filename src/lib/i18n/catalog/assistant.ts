...
export const assistantNamespaceCatalog = {
  en: {
    ...
    exportLabel: 'Export',
    exportMenuLabel: 'Export this conversation',
    exportMarkdown: 'Markdown (.md)',
    exportJson: 'JSON (.json)',
    exportDialogTitle: 'Export conversation',
    exportingLabel: 'Exporting…',
    exportSuccess: 'Conversation exported',
    exportError: "Couldn't export the conversation",
    exportDocTitle: 'PathKeep conversation',
    exportDocModel: 'Model',
    exportDocExported: 'Exported',
    exportDocModelUnknown: 'Keyword only',
    exportDocUser: 'You',
    exportDocAssistant: 'Assistant',
    exportDocReasoning: 'Reasoning',
    exportDocTools: 'Tools used',
    exportDocCitations: 'Citations',
    exportDocUsage: 'Tokens: {prompt} prompt · {completion} completion',
    exportDocNoAnswer: '(no answer)',
    exportDocError: '(error)',
    exportDocCancelled: '(stopped)',
  ...
  'zh-CN': {
    ...
    exportSuccess: '对话已导出',
    exportError: '导出对话失败',
    exportDocTitle: 'PathKeep 对话',
    exportDocModel: '模型',
    exportDocExported: '导出时间',
    exportDocModelUnknown: '关键词模式',
    exportDocUser: '你',
    exportDocAssistant: '助手',
    exportDocReasoning: '思考过程',
    exportDocTools: '使用的工具',
    exportDocCitations: '引用来源',
    exportDocUsage: 'Token：{prompt} 输入 · {completion} 输出',
    exportDocNoAnswer: '（无回答）',
    exportDocError: '（错误）',
    exportDocCancelled: '（已停止）',
    historyDoorway: '会话记录',
    historyTitle: '会话记录',
    historyOpen: '显示会话记录',
    historyClose: '隐藏会话记录',
  ...
  'zh-TW': {
    ...
    exportLabel: '匯出',
    exportMenuLabel: '匯出這個對話',
    exportMarkdown: 'Markdown (.md)',
    exportJson: 'JSON (.json)',
    exportDialogTitle: '匯出對話',
    exportingLabel: '正在匯出…',
    exportSuccess: '對話已匯出',
    exportError: '匯出對話失敗',
    exportDocTitle: 'PathKeep 對話',
    exportDocModel: '模型',
    exportDocExported: '匯出時間',
    exportDocModelUnknown: '關鍵字模式',
    exportDocUser: '你',
    exportDocAssistant: '助手',
    exportDocReasoning: '思考過程',
    exportDocTools: '使用的工具',
    exportDocCitations: '引用來源',
    exportDocUsage: 'Token：{prompt} 輸入 · {completion} 輸出',
    exportDocNoAnswer: '（無回答）',
    exportDocError: '（錯誤）',
    exportDocCancelled: '（已停止）',
    historyDoorway: '對話記錄',
    historyTitle: '對話記錄',
