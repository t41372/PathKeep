...
export const intelligenceOverviewAndRoutesNamespace = {
  en: {
    ...
    statusDisabledDescription:
      'Assistant and smart search are available but off by default. Enable them in Settings; keyword search and Core Intelligence work now without them.',
    ...
    digestSparklineAria: '{label} trend over the last {count} days',
    digestSparklineEmpty: 'Trend appears once more days are archived.',
    ...
    entityStarPageAria: 'Star this page',
    entityUnstarPageAria: 'Unstar this page',
    entityStarSourceAria: 'Star this source',
    entityUnstarSourceAria: 'Unstar this source',
    entityStarStatusStarred: 'Starred',
    entityStarStatusUnstarred: 'Unstarred',
    ...
    behaviorShapeGroupTitle: 'Behavior shape',
    comparisonsGroupTitle: 'Comparisons',
    lowSignalGroupTitle: 'Low-signal callouts',
    evidenceLibraryGroupTitle: 'Evidence Library',
    lowSignalGroupSummary: '{count} low-signal callouts available',
    lowSignalGroupExpand: 'Show callouts',
    lowSignalGroupCollapse: 'Hide callouts',
    healthDisclosureTitle: 'System health',
    healthDisclosureSummary: 'Storage, growth, and module health',
    healthDisclosureExpand: 'Show health details',
    healthDisclosureCollapse: 'Hide health details',
    healthDisclosureEmpty: 'No health data yet — complete a backup to start.',
    healthFreshnessLabel: 'Health',
    hubTimeAxisTitle: 'Time',
    hubSourcesAxisTitle: 'Sources',
    hubResearchAxisTitle: 'Research',
    hubSeeAll: 'See all',
    hubWeekdayLabel: 'Weekdays',
    hubWeekendLabel: 'Weekends',
    hubPeakHoursTitle: 'Peak Hours',
    hubPeakHoursEmpty: 'Not enough data to determine peak hours.',
    hubWeekdayWeekendEmpty: 'Not enough daily data yet.',
    hubSpotlightTitle: 'Spotlight',
    hubSpotlightEmpty: 'Not enough data for spotlight insights.',
    hubSpotlightRefind: 'You revisited "{title}" across {days} days.',
    hubSpotlightQueryFamily:
      'You searched for "{query}" in {count} different ways.',
    hubTopSitesPreview: 'Top Sites',
    hubStableSourcesPreview: 'Stable Sources',
    hubQueryFamiliesPreview: 'Query Families',
    hubRefindPreview: 'Refind Pages',
  },
  'zh-CN': {
    ...
    statusDisabledDescription:
      'AI 助手和智能搜索已可用，但默认关闭。在设置中开启即可；不开启时，关键词搜索和确定性智能分析也能正常使用。',
    ...
    digestDeepRead: '深度阅读',
    digestRefind: '重找页面',
    digestSparklineAria: '{label} 最近 {count} 天的趋势',
    digestSparklineEmpty: '积累更多天数后会显示趋势。',
    trendLabel: '{direction} {percent}%',
    visits: '次',
    ...
    entityStarPageAria: '收藏此页面',
    entityUnstarPageAria: '取消收藏此页面',
    entityStarSourceAria: '收藏此来源',
    entityUnstarSourceAria: '取消收藏此来源',
    entityStarStatusStarred: '已收藏',
    entityStarStatusUnstarred: '已取消收藏',
    ...
    behaviorShapeGroupTitle: '行为形态',
    comparisonsGroupTitle: '对比分析',
    lowSignalGroupTitle: '低信号提示',
    evidenceLibraryGroupTitle: '证据资料库',
    lowSignalGroupSummary: '有 {count} 条低信号提示可查看',
    lowSignalGroupExpand: '展开提示',
    lowSignalGroupCollapse: '收起提示',
    healthDisclosureTitle: '系统健康',
    healthDisclosureSummary: '存储、增长与模块健康度',
    healthDisclosureExpand: '展开健康详情',
    healthDisclosureCollapse: '收起健康详情',
    healthDisclosureEmpty: '尚无健康数据 — 完成一次备份后即可显示。',
    healthFreshnessLabel: '健康',
    hubTimeAxisTitle: '时间',
    hubSourcesAxisTitle: '来源',
    hubResearchAxisTitle: '研究',
    hubSeeAll: '查看全部',
    hubWeekdayLabel: '工作日',
    hubWeekendLabel: '周末',
    hubPeakHoursTitle: '高峰时段',
    hubPeakHoursEmpty: '数据不足，无法确定高峰时段。',
    hubWeekdayWeekendEmpty: '每日数据尚不充分。',
    hubSpotlightTitle: '亮点',
    hubSpotlightEmpty: '数据不足，无法生成亮点。',
    hubSpotlightRefind: '你在 {days} 天里反复访问了「{title}」。',
    hubSpotlightQueryFamily: '你用 {count} 种方式搜索了「{query}」。',
    hubTopSitesPreview: '最常访问',
    hubStableSourcesPreview: '稳定来源',
    hubQueryFamiliesPreview: '搜索演化',
    hubRefindPreview: '重找页面',
  },
  'zh-TW': {
    ...
    statusDisabledDescription:
      'AI 助手和智慧搜尋已可用，但預設關閉。在設定中開啟即可；不開啟時，關鍵字搜尋和確定性智慧分析也能正常使用。',
    ...
    digestDeepRead: '深度閱讀',
    digestRefind: '重找頁面',
    digestSparklineAria: '{label} 最近 {count} 天的趨勢',
    digestSparklineEmpty: '累積更多天數後會顯示趨勢。',
    trendLabel: '{direction} {percent}%',
    visits: '次',
    ...
    entityStarPageAria: '收藏此頁面',
    entityUnstarPageAria: '取消收藏此頁面',
    entityStarSourceAria: '收藏此來源',
    entityUnstarSourceAria: '取消收藏此來源',
    entityStarStatusStarred: '已收藏',
    entityStarStatusUnstarred: '已取消收藏',
    ...
    behaviorShapeGroupTitle: '行為形態',
    comparisonsGroupTitle: '對比分析',
    lowSignalGroupTitle: '低訊號提示',
    evidenceLibraryGroupTitle: '證據資料庫',
    lowSignalGroupSummary: '有 {count} 條低訊號提示可檢視',
    lowSignalGroupExpand: '展開提示',
    lowSignalGroupCollapse: '收起提示',
    healthDisclosureTitle: '系統健康',
    healthDisclosureSummary: '儲存、成長與模組健康度',
    healthDisclosureExpand: '展開健康詳情',
    healthDisclosureCollapse: '收起健康詳情',
    healthDisclosureEmpty: '尚無健康資料 — 完成一次備份後即可顯示。',
    healthFreshnessLabel: '健康',
    hubTimeAxisTitle: '時間',
    hubSourcesAxisTitle: '來源',
    hubResearchAxisTitle: '研究',
    hubSeeAll: '查看全部',
    hubWeekdayLabel: '工作日',
    hubWeekendLabel: '週末',
    hubPeakHoursTitle: '高峰時段',
    hubPeakHoursEmpty: '資料不足，無法確定高峰時段。',
    hubWeekdayWeekendEmpty: '每日資料尚不充分。',
    hubSpotlightTitle: '亮點',
    hubSpotlightEmpty: '資料不足，無法產生亮點。',
    hubSpotlightRefind: '你在 {days} 天裡反覆造訪了「{title}」。',
    hubSpotlightQueryFamily: '你用 {count} 種方式搜尋了「{query}」。',
    hubTopSitesPreview: '最常造訪',
    hubStableSourcesPreview: '穩定來源',
    hubQueryFamiliesPreview: '搜尋演化',
    hubRefindPreview: '重找頁面',
  },
} as const
