...
export const intelligenceSecondaryPatternsNamespace = {
  en: {
    ...
    discoveryTrendSparklineLabel: 'Discovery rate trend sparkline',
    discoveryTrendMeanLabel: 'Mean: {percent}%',
  ...
  'zh-CN': {
    ...
    discoveryTrendSparklineLabel: '探索率趋势迷你图',
    discoveryTrendMeanLabel: '均值：{percent}%',
  ...
  'zh-TW': {
    ...
    discoveryTrendSparklineLabel: '探索率趨勢迷你圖',
    discoveryTrendMeanLabel: '均值：{percent}%',
