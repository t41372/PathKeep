...
export const explorerNamespaceCatalog = {
  en: {
    ...
    paperBrowse: {
      ...
      contactSheetExpandStack: 'Toggle domain stack',
      contactSheetMoreInStack: '+',
  ...
  'zh-CN': {
    ...
    paperBrowse: {
      ...
      contactSheetExpandStack: '展开 / 收起 域名堆叠',
      contactSheetMoreInStack: '还有',
  ...
  'zh-TW': {
    ...
    paperBrowse: {
      ...
      contactSheetDayIndex: '第 {n} 天',
      contactSheetClearTarget: '清除',
      contactSheetExpandStack: '展開 / 收合 網域堆疊',
      contactSheetMoreInStack: '還有',
