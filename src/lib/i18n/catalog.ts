...
> = {
  en: {
    ...
    settings: {
      ...
      aiSaveConfig: 'Save AI settings',
      aiResetDraft: 'Reset draft',
      aiUnsavedChanges: 'AI configuration changes need review',
      aiDraftSaved: 'AI configuration draft matches the saved config',
      aiDraftBoundaryBody:
        'AI configuration edits stay local until you save. API keys still use their own explicit store and clear actions.',
      aiProviderName: 'Name',
      aiProviderId: 'ID',
  ...
  'zh-CN': {
    ...
    settings: {
      ...
      aiSaveConfig: '保存 AI 设置',
      aiResetDraft: '重置草稿',
      aiUnsavedChanges: 'AI 配置变更需要审查',
      aiDraftSaved: 'AI 配置草稿与已保存配置一致',
      aiDraftBoundaryBody:
        'AI 配置编辑会先保留在本地，只有保存后才会写入。API 密钥仍然使用独立的保存与清除动作。',
      aiProviderName: '名称',
      aiProviderId: 'ID',
  ...
  'zh-TW': {
    ...
    settings: {
      ...
      aiSaveConfig: '儲存 AI 設定',
      aiResetDraft: '重設草稿',
      aiUnsavedChanges: 'AI 設定變更需要審查',
      aiDraftSaved: 'AI 設定草稿與已儲存設定一致',
      aiDraftBoundaryBody:
        'AI 設定編輯會先保留在本地，只有儲存後才會寫入。API 金鑰仍然使用獨立的儲存與清除動作。',
      aiProviderName: '名稱',
      aiProviderId: 'ID',
