...
const zhCnM3Namespaces = {
  ...
  explorer: {
    ...
    exportDescription:
      '导出范围为当前筛选条件下的可见记录。目前支持导出访问记录，更多导出类型将在后续版本中加入。',
    copied: '已复制',
    noResultEyebrow: '详情',
...
const zhTwM3Namespaces = {
  ...
  explorer: {
    ...
    exportDescription:
      '匯出範圍為目前篩選條件下的可見紀錄。目前支援匯出瀏覽紀錄，更多匯出類型將在後續版本加入。',
    copied: '已複製',
    noResultEyebrow: '詳情',
...
> = {
  en: {
    ...
    explorer: {
      ...
      exportDescription:
        'Exports the currently visible search results. More export formats coming later.',
      copied: 'Copied',
