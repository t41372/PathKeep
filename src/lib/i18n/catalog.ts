...
> = {
  en: {
    ...
    audit: {
      ...
      detailEmptyTitle: 'Select a backup to inspect',
      detailEmptyBody:
        'Click any block in the chain above to see details about that backup run.',
      filterLabel: 'FILTERS',
      ...
      deltaBody: 'See what changed compared to the previous backup.',
  ...
  'zh-CN': {
    ...
    audit: {
      ...
      warningsTab: '警告',
      noWarnings: '这次运行没有警告。',
      detailEmptyTitle: '选择一条备份记录',
      detailEmptyBody: '点击上方备份链中的任意一项，查看该次备份的详细信息。',
      filterLabel: '筛选',
  ...
  'zh-TW': {
    ...
    audit: {
      ...
      warningsTab: '警告',
      noWarnings: '這次執行沒有警告。',
      detailEmptyTitle: '選擇一筆備份紀錄',
      detailEmptyBody: '點擊上方備份鏈中的任一項，查看該次備份的詳細資訊。',
      filterLabel: '篩選',
