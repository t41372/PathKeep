...
| `floorp.png`    | Converted from `https://floorp.app/favicon.svg`; the upstream SVG is a base64-wrapped 1024px PNG, so PathKeep stores a 256px PNG to avoid WebKit startup stalls. |
