...
pub use self::{
    ...
    intelligence::{
        ...
        cancel_model_download, delete_ai_conversation, delete_search_engine_rule,
        download_ai_embedding_model, explain_entity, explain_refind, get_activity_mix,
        ...
        list_ai_conversations, list_search_engine_rules, load_ai_assistant_job,
        load_ai_conversation, load_ai_queue, load_intelligence_runtime_snapshot,
        preview_ai_integration_files, preview_intelligence_local_host,
        queue_core_intelligence_rebuild, rename_ai_conversation, replay_ai_job,
        retry_intelligence_job_now, run_ai_queue_jobs, run_core_intelligence_now,
        save_ai_conversation, search_ai_history, test_ai_provider_connection_report,
