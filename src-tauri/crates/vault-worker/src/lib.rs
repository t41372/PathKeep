...
pub use self::{
    ...
    intelligence::{
        ...
        cancel_intelligence_job_now, explain_entity, explain_refind, get_activity_mix,
        get_activity_mix_trend, get_breadth_index, get_browsing_rhythm, get_compare_sets,
        get_digest_summary, get_discovery_trend, get_domain_deep_dive, get_domain_trend,
        get_friction_signals, get_habit_patterns, get_hub_pages, get_intelligence_embed_cards,
        get_intelligence_public_snapshot, get_intelligence_widget_snapshot, get_interrupted_habits,
        get_multi_browser_diff, get_navigation_path, get_observed_interactions, get_on_this_day,
        ...
        load_ai_assistant_job, load_ai_queue, load_intelligence_runtime_snapshot,
        preview_ai_integration_files, preview_intelligence_local_host,
        queue_core_intelligence_rebuild, replay_ai_job, retry_intelligence_job_now,
        run_ai_queue_jobs, run_core_intelligence_now, search_ai_history,
