...
pub use self::{
    ...
    intelligence::{
        ...
        explain_refind, get_activity_mix, get_activity_mix_trend, get_browsing_rhythm,
        get_digest_summary, get_discovery_trend, get_domain_deep_dive, get_domain_trend,
        get_friction_signals, get_hub_pages, get_navigation_path, get_on_this_day,
        ...
        preview_ai_integration_files, queue_core_intelligence_rebuild, replay_ai_job,
