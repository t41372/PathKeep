...
pub use ai::{
    ...
    apply_role_instruction, binarize, binary_bytes_for_dim, build_ai_index,
    build_ai_index_with_control, build_dedup_content_hash, build_planes_from_store,
    ...
    reembed_estimate_for, register_ai_chat_run, request_ai_chat_cancel, run_code_in_sandbox,
