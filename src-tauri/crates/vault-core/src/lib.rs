...
pub use ai::{
    ALLOWLIST_EXPANSION, AiIntegrationPreview, AiProviderRuntime, AiRunCancelled, AiRunControl,
    AnyEmbeddingProvider, BinaryPlane, CANDLE_INAPP_BASE_URL, CandidateSignals,
    CandleEmbeddingProvider, DEFAULT_CANDLE_MODEL_FILES, DEFAULT_CANDLE_MODEL_REPO,
    DEFAULT_CANDLE_QUANT, DEFAULT_CANDLE_TOKENIZER_REPO, DEFAULT_STATIC_MODEL_FILES,
    DEFAULT_STATIC_MODEL_REPO, EMBEDDING_FINGERPRINT_VERSION, EmbeddingDescriptor, EmbeddingDtype,
    ...
    dot_product, drive_ai_chat_stream, ensure_model_downloaded, gguf_file_name, hamming_distance,
    ...
    quantize_int8, reconcile_ai_queue_controls, register_ai_chat_run, request_ai_chat_cancel,
