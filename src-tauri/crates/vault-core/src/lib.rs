...
pub use ai::{
    ...
    CANDLE_INAPP_BASE_URL, CandidateSignals, CandleEmbeddingProvider, CodeOutcome,
    ...
    MAX_HOST_CALLS, MAX_OUTPUT_BYTES, MAX_ROWS_PER_CALL, MAX_WORKING_SET, ModelDownloadProgress,
    ModelFile, NarrativeSummary, NoopDownloadProgress, PlaneBuildReport, PlaneHeader,
    QWEN3_QUERY_TASK, QueryFamilyFacts, RECALL_EXPANSION, RECALL_FLOOR, RigLlmProvider,
    STATIC_INAPP_BASE_URL, STATIC_MAX_INPUT_TOKENS, StaticEmbeddingMatrix, StaticEmbeddingProvider,
    ToolRegistry, TopicFacts, VectorIndex, VectorStore, VectorStoreHeader, VisitContentMap,
    WALL_TIME_BUDGET, WorkingSetCandidate, WorkingSetConfig, ai_index_status, ai_queue_status,
    ...
    drive_ai_chat_stream, ensure_model_downloaded, gguf_file_name, hamming_distance,
    ...
    register_ai_chat_run, request_ai_chat_cancel, run_code_in_sandbox, runtime_uses_candle,
    runtime_uses_static, score_candidate, select_embedding_provider, select_working_set,
    semantic_search_history, static_embed_ids, static_l2_normalize, static_repo_for_runtime,
    summarize_query_family, summarize_topic, test_provider_connection, vector_plane_bytes,
    visit_map_plane_bytes,
};
pub use annotations::{
