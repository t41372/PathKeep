...
#[cfg(not(test))]
#[tauri::command]
pub(crate) fn preview_schedule(platform: Option<String>) -> Result<vault_core::SchedulePlan, String> {
    worker_bridge::preview_schedule_impl(platform)
}

#[cfg(not(test))]
#[tauri::command]
pub(crate) fn apply_schedule(plan: vault_core::SchedulePlan) -> Result<vault_core::ApplyResult, String> {
    worker_bridge::apply_schedule_impl(plan)
}

#[cfg(not(test))]
#[tauri::command]
pub(crate) fn remove_schedule(plan: vault_core::SchedulePlan) -> Result<vault_core::ApplyResult, String> {
