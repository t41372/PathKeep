...
- [ ] **WORK-V03-PAPER-REDESIGN-A** — Paper + Archival Frontend Rebuild (foundation shipped, route sweep pending)
  ...
  - 進度（2026-05-25 update — feedback-2026-05-25 §3.2 + §3.3 B closeout）：
    ...
    - 🟡 **Remaining feedback-2026-05-25 items** (each warrants its own dedicated work block, see BACKLOG):
      ...
      - `WORK-FEEDBACK-0525-EXPORT-IMPORT` — feature §2.1 full app data export/import (user-blocking — needed to migrate their notebook PathKeep data onto this dev machine before real testing of larger archives).
