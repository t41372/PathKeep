...
- [ ] **WORK-RELEASE-020-A** — v0.2.0 Planning Repair, Security Refresh, And Publication
  - 讀先：
    `README.md`
    `RELEASE.md`
  ...
  - 驗收：
    - GitHub Dependabot open alerts 已對應到 patched dependency versions 或明確記錄為等待 GitHub rescan。
