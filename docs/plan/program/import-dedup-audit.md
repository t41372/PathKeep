...
| E9 — `hidden` URL flag round-trip                  | [`e9_hidden_url_flag_round_trips_for_both_true_and_false`](../../src-tauri/crates/vault-core/src/archive/ingest/dedup_scenarios_edge_cases.rs)                                           | `hidden = true` source URL (Chrome redirect intermediates) lands as non-zero in archive; `hidden = false` lands as 0. Pins flag-preservation contract that C-series didn't exercise.                                                                                             |
| E10 — Chromium visit_count zero/nonzero            | [`e10_chromium_visit_counts_round_trip_for_zero_and_nonzero_urls`](../../src-tauri/crates/vault-core/src/archive/ingest/dedup_scenarios_edge_cases.rs)                                   | Chrome URL rows with `visit_count = 0` and `visit_count = 7` preserve their lifetime counts and typed counts, even when the zero-count URL has no visit row.                                                                                                                     |
| E11 — Chromium dangling from_visit                 | [`e11_chromium_dangling_from_visit_is_preserved_verbatim`](../../src-tauri/crates/vault-core/src/archive/ingest/dedup_scenarios_edge_cases.rs)                                           | A `from_visit` value pointing at a missing source visit is stored as-is instead of being rewritten to NULL/0, pinning current referential-evidence behavior.                                                                                                                     |
| E12 — Chromium visit duration value                | [`e12_chromium_visit_duration_value_is_preserved_verbatim`](../../src-tauri/crates/vault-core/src/archive/ingest/dedup_scenarios_edge_cases.rs)                                          | The source `visits.visit_duration` value passes through to archive `visits.visit_duration_ms` unchanged; this pins current value-preservation semantics.                                                                                                                         |
| E13 — Safari synthesized context evidence          | [`e13_safari_synthesized_context_evidence_persists_boolean_value`](../../src-tauri/crates/vault-core/src/archive/ingest/dedup_scenarios_edge_cases.rs)                                   | Current-schema Safari `history_visits.synthesized = 1` persists to cold `visit_context_evidence` as `context_key = safari.synthesized`, `value_json = true`, with source visit/url ids preserved.                                                                                |
| E14 — Firefox visit_type passthrough               | [`e14_firefox_visit_type_enum_lands_as_transition_type_without_normalization`](../../src-tauri/crates/vault-core/src/archive/ingest/dedup_scenarios_edge_cases.rs)                       | Firefox `moz_historyvisits.visit_type` values land in archive `visits.transition_type` unchanged, rather than being normalized to Chromium transition values.                                                                                                                    |
