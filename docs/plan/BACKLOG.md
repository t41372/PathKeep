...
> 2026-05-03 M14 follow-up note：`WORK-M14-A` 已完成 deterministic lexical recall v2 primary path；fuzzy typo tolerance / alias expansion 不能直接接進 SQL 或第一刀，必須先做候選量 benchmark 與 dedicated design window。
