...
- keyring status / get / set / clear、archive unlock session 與 rekey execute 基礎已經存在於 worker / platform surface，但 rekey preview、security trust UI 與 Linux keyring UX 仍待後續 UX block。
