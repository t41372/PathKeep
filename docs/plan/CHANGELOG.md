...
- [x] `WORK-AI-4C-STATIC-DEDUP` (2026-06-21, UNCOMMITTED on `feat/ai-redesign-2026`) — model2vec static base tier + content-hash dedup + heavy-working-set selector.
  ...
  - **W-AI-4c review-fix pass (2026-06-21, UNCOMMITTED)** — confirmed review findings fixed in place:
