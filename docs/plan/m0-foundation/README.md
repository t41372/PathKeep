...
- repo 目前固定的 targeted blocking JS gate 是 desktop contract slice：`bun run test:unit:desktop-contract`、`bun run coverage:js:desktop-contract`、`bun run mutation:js:desktop-contract`；前端 shell 自身的驗收需另行維護。
