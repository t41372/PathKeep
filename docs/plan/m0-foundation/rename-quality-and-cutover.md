...
> 2026-04-06 基線更新：repo-wide doc formatting / Prettier debt 已清理，驗收途中浮出的 JS ESLint 與 Rust Clippy 基線問題也已修復；`bun run check` / `bun run build` 目前再次通過，可恢復作為 M0 期間的硬 gate。
