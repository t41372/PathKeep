...
- `Browsing Rhythm` 主圖必須對應**真實日期**；目前 accepted contract 是 GitHub 式日曆熱力圖，點某一天後預設進 `/intelligence/day/:date` 的完整 day insights route。overview 若保留任何 inline preview，也只能是次要資訊，不可重新變回主要工作流。
