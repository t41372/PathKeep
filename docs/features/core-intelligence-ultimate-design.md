...
> **2026-04-17 implementation note:** runtime / Jobs artifact 現在會補充 `executionMode`、`affectedProfiles`、`dirtyVisitCount`、`dirtyDateKeys`、`fallbackReason`。這些欄位的定位是 queue/review truth，不代表 10M / 14.4M / low-RAM signoff 已完成。
...
│                                                                              │
│  ┌─ 歷史上的今天 ───────────────┐  ┌─ Top 網站 ───────────────────────┐     │
│  │ 📅 2025-04-15                │  │ 1. GitHub ·········· 847 次     │     │
│  │  「在研究 Tauri v2 文檔」     │  │ 2. YouTube ········· 612 次     │     │
│  │ 📅 2024-04-15                │  │ 3. Stack Overflow ·· 389 次     │     │
│  │  「大量瀏覽 BiliBili」        │  │ 4. BiliBili ········ 234 次     │     │
│  │ [查看更多年份 →]              │  │ 5. Google ·········· 201 次     │     │
│  └──────────────────────────────┘  │ [搜索特定網站...] [查看全部 →]   │     │
│                                    └──────────────────────────────────┘     │
│                                                                              │
│  ┌─ 搜索活動 ────────────────────────────────────────────────────────────┐   │
