...
| Embed / widget payload providers          | backend command                               | **backend-only**                    | backend 現在可產生 intelligence embed cards、widget snapshot、public snapshot payload；前端 / host integration 還沒接完                                   |
