...
| Section evidence / freshness drawer       | Intelligence、domain deep dive                                    | **Shipping after 2026-04-18**                    | backend section envelope 現在會帶 `generatedAt`、scope/window、module/source-table provenance、enrichment flag、以及 stale / disabled / degraded reason；Settings / Jobs 仍擁有 rebuild / clear / retry                                                |
