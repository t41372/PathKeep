...
bun run check:desktop-contract # desktop contract slice 的 targeted unit + coverage + mutation sub-gate
...
bun run mutation:rust    # Rust workspace 的 scheduled/manual mutation deep check
